...
public interface IProductDao {
     ...
     * with the same id will be overwritten with the information from the given product.
     * @param product with the informations already updated to persist in the database
    ...
    /**
     * Updates the description of the product matching the given id for the given locale.
     * @param id of the product to update
     * @param locale for which the description needs to be updated
     * @param newDesc description that is to replace the current description for the product.
     * @return true if update successful, else false.
     */
    boolean updateProductDescriptionFromId(Integer id, String locale, String newDesc);
    
    /**
     * Updates the available quantity of a product matching the given id with the given new quantity.
     * @param id of the product to update.
