...
public class ProductDaoImplTest {
    ...
    public void testSaveProduct() {
        ...
        Product product = new Product("desc1", "img1", 1, 10.00, true, false);
    ...
    public void testGetProductById() {
        ...
        Product productSet = new Product("desc1", "img1", 1, 10.00, true, false);
        // set up for test
    ...
    public void testUpdateProduct() {
        ...
        productDaoImpl.saveProduct(new Product("desc1", "img1", 1, 10.10, true, false));
    ...
    public void testDeleteAllProducts() {
        ...
        productDaoImpl.saveProduct(new Product("desc1", "img1", 1, 10.10, true, true));
        productDaoImpl.saveProduct(new Product("desc2", "img2", 2, 20.20, false, false));
        productDaoImpl.saveProduct(new Product("desc3", "img3", 3, 30.30, true, true));
        int expectedSize = 3;
